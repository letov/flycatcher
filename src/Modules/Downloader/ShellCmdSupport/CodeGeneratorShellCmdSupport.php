...
class CodeGeneratorShellCmdSupport
{
    static function generate()
    {
        ...
        }, glob(__DIR__ . '/../ArgsSupport/ArgInterfaces/*.php'));
        $argInterfaces = array_diff(get_declared_interfaces(), $interfaces);

        $argsSupportShellCmdNamespace = new PhpNamespace('Letov\Flycatcher\Modules\Downloader\ShellCmdSupport');
        $argsSupportShellCmdClass = $argsSupportShellCmdNamespace->addClass("AbstractShellCmdSupport");
        ...
        file_put_contents(__DIR__ . '/AbstractShellCmdSupport.php',
